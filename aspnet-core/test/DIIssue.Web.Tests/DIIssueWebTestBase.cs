...
{
    public abstract class DIIssueWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DIIssueWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DIIssueWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DIIssueDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DIIssueDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DIIssueDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DIIssueDbContext, Task<T>> func)
        {
            T result;
